...
echo "AZURE_OPENAI_EMBEDDING_DIMENSIONS=$(azd env get-value AZURE_OPENAI_EMBEDDING_DIMENSIONS)" >> .env
echo "AZURE_AI_VISION_ENDPOINT=$(azd env get-value AZURE_AI_VISION_ENDPOINT)" >> .env
